...
class genericConnector {
    ...
    constructor() {
      ...
      this.url = urlParams.get("ontology")
      this.ontoname = urlParams.get("ontologyname")
    ...
    async search_for_class(searchString) {
      ...
      const response = await axios.get(this.url + "/" + this.ontoname + "/functions/basic/searchCls/" + searchString + "*")
  ...
  async get_cls_data(Cls) {
      try {
          ...
          console.log(this.url + "/"+this.ontoname+"/cls/" + cls_id + "?ns=" + namespace)
